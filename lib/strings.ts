...
export const strings = {
  ...
  documents: {
    ...
    lockNow: "נעילת הכספת",
    offlinePlainWarning:
      "המסמך הזה לא נעול, אז העותק שיישמר במכשיר יהיה קריא לכל מי שמחזיק בו — בלי סיסמה. למסמכים רגישים כמו דרכון עדיף לנעול קודם (🔓) ואז לשמור אופליין. לשמור בכל זאת?",
