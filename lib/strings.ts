...
export const strings = {
  ...
  budget: {
    ...
    save: "שמירה",
    // overall trip budget
    editTotalBudget: "עריכת התקציב הכולל",
    totalBudgetField: "תקציב כולל לטיול (₪)",
    totalBudgetHint:
      "אפשר לקבוע תקציב כולל לטיול ואז לחלק אותו בין הקטגוריות. אם משאירים ריק, הסה״כ מחושב מסכום הקטגוריות כמו קודם.",
    totalBudgetInvalid: "צריך מספר חיובי",
    totalBudgetAllocated: "מחולק כרגע לקטגוריות: ₪{n}",
    clearTotalBudget: "ביטול התקציב הכולל (חזרה לחישוב מהקטגוריות)",
    unallocated: "לא מחולק",
    overAllocated: "חורג מהתקציב הכולל",
    // categories
