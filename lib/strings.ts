...
export const strings = {
  ...
  links: {
    title: "קישורים שמורים",
    subtitle: "פוסטים, כתבות וטיפים ששמרתם — מסודרים לפי מדינה ואזור",
    add: "הוספת קישור",
    edit: "עריכת קישור",
    linkTitle: "כותרת",
    url: "כתובת (URL)",
    ...
    note: "הערה (לא חובה)",
    save: "שמירה",
    empty: "עוד לא שמרתם קישורים",
    open: "פתיחה",
    deleteConfirm: "למחוק את הקישור?",
    ungrouped: "כללי",
    invalid: "צריך למלא כותרת וכתובת",
    ownersOnly: "התכונה זמינה להורים בלבד",
  },
