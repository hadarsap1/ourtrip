...
export const strings = {
  ...
  today: {
    ...
    inHours: "בעוד {n} שעות",
    nowLabel: "עכשיו",
    nothingLeftToday: "אין עוד פעילויות מתוכננות היום",
    tileWeather: "מזג אוויר",
    tileTonight: "הלילה",
    tileSpentToday: "הוצאות היום",
    tileRemaining: "נותר בתקציב",
    agenda: "לוח היום",
  ...
  documents: {
    ...
    tag: "תגית",
    notes: "הערות",
    expiresAt: "תוקף עד (לא חובה)",
    expiresAtHint: "אם המסמך פג לפני סוף הטיול, תופיע התראה במסך המסמכים",
    // redesign 3a
    pinBadge: "מוגן בקוד",
    searchFull: "חיפוש לפי שם, סוג או הערה",
    expiryWarnTitle: "{title} פג לפני סוף הטיול",
    expiryWarnBody: "תוקף עד {expiry} · הטיול נמשך עד {end}",
    expiryWarnMore: "ועוד {n} מסמכים",
    expiresOn: "תוקף עד {date}",
    offlineHeader: "זמינים אופליין",
    offlineCount: "{n} מתוך {total}",
    scan: "צילום מסמך",
    file: "קובץ",
    uploading: "מעלה…",
    ...
    lockNow: "נעילת הכספת",
    pinSetTitle: "הגדרת סיסמה למסמכים",
    pinEnterTitle: "פתיחת הכספת",
    pinField: "ביטוי סיסמה (10 תווים לפחות)",
    pinConfirm: "הקלדה שוב",
    pinInvalid: "ביטוי הסיסמה חייב להיות באורך 10 תווים לפחות",
    pinMismatch: "שתי ההקלדות לא תואמות",
    pinWrong: "סיסמה שגויה - נסו שוב",
    pinExists: "כבר הוגדרה סיסמה למסמכים",
    pinWarning:
      "הצפנה מקצה לקצה: אם שוכחים את הסיסמה אי אפשר לשחזר את המסמכים הנעולים - גם אנחנו לא. שמרו אותה במקום בטוח.",
    pinHint:
      "עדיף משפט שקל לזכור וקשה לנחש - למשל שלוש מילים לא קשורות. ארוך עדיף על מסובך.",
    pinAck: "הבנתי - אין דרך לשחזר סיסמה שנשכחה",
    pinSave: "שמירה ונעילה",
    pinUnlock: "פתיחה",
    pinShow: "הצגת הסיסמה",
    pinHide: "הסתרת הסיסמה",
    viewerClose: "סגירה",

    // biometric unlock (WebAuthn)
    bioUnlock: "פתיחה עם זיהוי ביומטרי",
    bioOr: "או",
    bioEnrollTitle: "פתיחה מהירה במכשיר הזה",
    bioEnrollBody:
      "אפשר לפתוח את הכספת עם טביעת אצבע או זיהוי פנים במקום להקליד את ביטוי הסיסמה. הזיהוי נשאר במכשיר - אנחנו לא מקבלים ולא שומרים שום נתון ביומטרי.",
    bioEnroll: "הפעלה במכשיר הזה",
    bioEnrolled: "המכשיר הזה מוגדר לפתיחה מהירה",
    bioEnrollDone: "הפתיחה המהירה הופעלה",
    bioDevicesTitle: "מכשירים שיכולים לפתוח את הכספת",
    bioRemove: "הסרה",
    bioRemoved: "המכשיר הוסר",
    bioNeverUsed: "עדיין לא היה בשימוש",
    bioLastUsed: "בשימוש אחרון",
    bioCancelled: "הפתיחה בוטלה",
    bioUnsupported: "המכשיר הזה לא תומך בפתיחה ביומטרית",
    bioFailed: "הפתיחה המהירה נכשלה - אפשר להקליד את ביטוי הסיסמה",
  },
  ...
  budget: {
    ...
    save: "שמירה",
    // overall trip budget
    editTotalBudget: "יעד תקציב לטיול",
    totalBudgetField: "יעד תקציב לטיול (₪)",
    totalBudgetHint:
      "היעד הוא כמה יש לכם לטיול. המספר המתוכנן תמיד מחושב מסכום הקטגוריות ומתעדכן מיד כשמשנים אחת מהן - כאן קובעים רק מול מה הוא נמדד. אפשר להשאיר ריק.",
    totalBudgetInvalid: "צריך מספר חיובי",
    totalBudgetAllocated: "מתוכנן כרגע בקטגוריות: ₪{n}",
    clearTotalBudget: "ביטול היעד",
    plannedLabel: "מתוכנן בקטגוריות",
    target: "יעד תקציב",
    setTarget: "קביעת תקציב כולל לטיול",
    leftToAllocate: "נותר לחלוקה",
    overTarget: "חריגה מהיעד",
    // categories
    addCategory: "קטגוריה חדשה",
    editCategory: "עריכת קטגוריה",
    categoryName: "שם הקטגוריה",
    deleteCategory: "מחיקת הקטגוריה",
    deleteCategoryConfirm: "למחוק את הקטגוריה?",
    categoryInUse: "אי אפשר למחוק קטגוריה שיש בה הוצאות - העבירו אותן קודם",
  ...
  options: {
    ...
    pickAdd: "הוספת {n} למסלול",
    pickNoneChosen: "בחרו מקומות להוספה",
    pickAlready: "‏{n} כבר על היום הזה",
    plannedMany: "‏{n} מקומות נוספו למסלול",
  ...
  mailImport: {
    ...
    notConfigured:
      "חיבור Google לא מוגדר. חסר NEXT_PUBLIC_GOOGLE_CLIENT_ID במשתני הסביבה ב-Vercel - אחרי הוספה צריך לפרוס מחדש.",
    fromDate: "מתאריך",
    toDate: "עד תאריך",
  ...
  wall: {
    guestTitle: "קיר האורחים",
    familyTab: "משפחה",
    guestTab: "אורחים",
    familyHint: "הקיר הזה נשאר בין ההורים והילדים - אורחים לא רואים אותו.",
    guestHint: "הקיר הזה משותף עם האורחים שהוזמנו. הילדים לא רואים אותו.",
    title: "הקיר המשפחתי",
  ...
  pocket: {
    title: "דמי כיס",
    // shown when a kid saved an expense without typing what it was
    noDescription: "קנייה",
